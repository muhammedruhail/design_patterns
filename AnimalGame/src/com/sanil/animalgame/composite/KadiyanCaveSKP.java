 ...
 */
public class KadiyanCaveSKP extends CaveSKP {

	/**
	 * Constructor for class KadiyanCaveSKP
	 * 
	 * @param string
	 */
	public KadiyanCaveSKP(String nameSKP) {

		super(nameSKP);
	}

	/**
	 * Clone {@link KadiyanCaveSKP}
	 */
	@Override
	public CaveSKP cloneSKP() {

		return new KadiyanCaveSKP(nameSKP);
	}
