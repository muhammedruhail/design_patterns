...
import com.sanil.animalgame.animals.IOTBasedFoxSKP;
import com.sanil.animalgame.animals.IOTBasedLionSKP;
...
public class IOTBasedAnimalSRFactorySKP extends AnimalCharacterAbstractFactorySKP {
	...
	public AnimalSKP createHeroCharacter() {
		return new IOTBasedFoxSKP("Soothran");
	}
	...
	public AnimalSKP createFriendCharacter() {
		...
		return new IOTBasedTigerSKP("Sheru");
	}
	...
	public AnimalSKP createVillainCharacter() {
		// TODO Auto-generated method stub
		return new IOTBasedLionSKP("Kadiyan");
	}
